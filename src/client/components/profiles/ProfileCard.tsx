    ...
    <Card className="p-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <Link
          ...
          className="inline-flex shrink-0 items-center gap-1 rounded-md bg-white/[0.05] px-2 py-1 text-[11px] font-medium tabular-nums text-[var(--pc-text-secondary)] transition-colors hover:bg-[var(--pc-accent-muted)] hover:text-[var(--pc-accent-hover)]"
